...
public class ListaDeGrupoController
{
    ...
    /**
     * Insere um sintagma em algum grupo. Se for solitário (set = -1), insere na
     * lista de sintagmas solitários. Caso contrário, insere na lista correta
     * buscando pelo número do set.
     *
     * @param s Sintagma a ser inserido
     * @return
     */
